...
<?php $__env->startSection('document_name', 'BUKTI FAKTUR KEUANGAN'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <tr>
            <td>
                <div class="info-box">
                    ...
                    Tenggat (Jatuh Tempo): <strong style="color: red;"><?php echo e($invoice->due_date?->format('d F Y') ?? '—'); ?></strong><br>
            ...
            <td>
                <div class="info-box">
                    ...
                    <strong><?php echo e($entity); ?></strong>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            <tr>
                <td>
                    Ref. PO: <b><?php echo e($invoice->purchaseOrder?->po_number ?? '—'); ?></b><br>
                    Ref. GR: <b><?php echo e($invoice->goodsReceipt?->gr_number ?? '—'); ?></b>
                </td>
                <td style="padding: 0;">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            <td style="border: 0; padding: 10px; border-bottom: 1px dotted #ccc;">Total Hutang/Piutang Keseluruhan</td>
                            <td style="border: 0; padding: 10px; text-align: right; border-bottom: 1px dotted #ccc; font-weight: bold;">Rp <?php echo e(number_format($invoice->total_amount, 0, ',', '.')); ?></td>
                        </tr>
                        <tr>
                            <td style="border: 0; padding: 10px; border-bottom: 1px solid #e2e8f0;">Total Kas Tercatat (Sudah Dilunasi)</td>
                            <td style="border: 0; padding: 10px; text-align: right; border-bottom: 1px solid #e2e8f0; color: green;">Rp <?php echo e(number_format($invoice->paid_amount, 0, ',', '.')); ?></td>
                        </tr>
                        <tr style="background-color: #f8fafc;">
                            ...
                            <td style="border: 0; padding: 10px; text-align: right; font-weight: bold; font-size: 16px; color: #dc2626;">Rp <?php echo e(number_format($invoice->total_amount - $invoice->paid_amount, 0, ',', '.')); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo e(number_format($item->quantity, 0, ',', '.')); ?></td>
