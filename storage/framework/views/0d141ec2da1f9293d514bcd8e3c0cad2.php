...
<head>
    <meta charset="utf-8">
    <title><?php echo $__env->yieldContent('title', 'Dokumen Medikindo'); ?></title>
    <style>
        body {
    ...
    <div class="header">
        <table>
            <tr>
                ...
                <td>
                    <h2 class="doc-title"><?php echo $__env->yieldContent('document_name'); ?></h2>
                    <div class="doc-meta">
                        Nomor: <b><?php echo $__env->yieldContent('document_number'); ?></b><br>
                        Tanggal: <?php echo $__env->yieldContent('document_date'); ?><br>
                        Halaman: 1 / 1
                    </div>
                </td>
            </tr>
...
<?php /**PATH C:\laragon\www\medikindo-po\resources\views/pdf/layout.blade.php ENDPATH**/ ?>