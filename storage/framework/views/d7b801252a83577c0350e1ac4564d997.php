<?php if($paginator->hasPages()): ?>
    <nav aria-label="Pagination Navigation" class="d-flex justify-content-end">
        <ul class="pagination pagination-clean mb-0">
            
            <?php if($paginator->onFirstPage()): ?>
                <li class="page-item disabled" aria-disabled="true" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">
                    <span class="page-link">
                        <i class="ki-outline ki-black-left fs-3"></i>
                    </span>
                </li>
            <?php else: ?>
                <li class="page-item">
            ...
            <?php if($paginator->hasMorePages()): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">
                        <i class="ki-outline ki-black-right fs-3"></i>
                    </a>
                </li>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\medikindo-po\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>