                ...
                <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
                    ...
                    <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                            <!--begin::Form-->
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="<?php echo e(route('login')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <!--begin::Heading-->
                                ...
                                <div class="alert alert-danger d-flex align-items-center p-4 mb-8">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="fs-7"><?php echo e(session('error')); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="fv-row mb-8">
                                    <input type="email" placeholder="Email Address" name="email" value="<?php echo e(old('email')); ?>" autocomplete="email" class="form-control form-control-solid bg-transparent" required />
                                </div>
                                <!--end::Input group=-->
                                <div class="fv-row mb-8">
...
<?php /**PATH C:\laragon\www\medikindo-po\resources\views/auth/login.blade.php ENDPATH**/ ?>