                                ...
                                <td class="text-end pe-4">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <form method="POST" action="<?php echo e(route('web.organizations.toggle_status', $org)); ?>" 
                                                  onsubmit="return confirm('<?php echo e($org->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?> organisasi ini?')" class="d-inline">
                                                <?php echo csrf_field(); ?>
