                ...
                <form method="POST" action="{{ route('web.organizations.store') }}">
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="customer_code" value="{{ old('customer_code') }}" maxlength="50"
                                   class="form-control form-control-solid" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="default_tax_rate" value="{{ old('default_tax_rate', 11) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="default_discount_percentage" value="{{ old('default_discount_percentage') }}" 
                                   step="0.01" min="0" max="100"
                                   class="form-control form-control-solid" 
                                   placeholder="5.00">
