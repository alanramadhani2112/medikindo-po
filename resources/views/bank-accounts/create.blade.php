                    ...
                    <form method="POST" action="{{ route('web.bank-accounts.store') }}">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="account_type"
                                ...
                                required>
                                <option value="both"    {{ old('account_type', 'both') === 'both'    ? 'selected' : '' }}>
                                    🔄 Masuk & Keluar — bisa terima dari RS dan kirim ke Supplier
                                </option>
                                <option value="receive" {{ old('account_type') === 'receive' ? 'selected' : '' }}>
                                    ⬇️ Terima Masuk saja — khusus menerima pembayaran dari RS/Klinik
                                </option>
                                <option value="send"    {{ old('account_type') === 'send'    ? 'selected' : '' }}>
                            ...
                            @error('account_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-muted">Tentukan fungsi rekening ini dalam alur cashflow Medikindo</div>
                        </div>
