    ...
    <div class="app-container container-fluid d-flex align-items-center justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <div class="d-flex flex-column">
                <h1 class="text-gray-900 fw-bold fs-3 mb-0">{{ $pageTitle ?? 'Dashboard' }}</h1>
        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-1 ms-md-3">
                ...
                <a href="{{ route('web.notifications.index') }}" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative">
