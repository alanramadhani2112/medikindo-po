...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-7">
        <div>
            ...
            <p class="text-gray-600 fs-6 mb-0">Konfigurasi harga jual untuk RS/Klinik dan produk tertentu</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title fw-bold">Form Harga Jual</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('web.price-lists.store') }}">
                        @csrf
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('expiry_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text text-muted">Kosongkan jika tidak ada tanggal kadaluarsa.</div>
                            </div>
                        </div>
