                    ...
                    <form method="POST" action="{{ url('/products') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-5">
                                    <label class="form-label fs-6 fw-semibold">Harga Satuan (Rp) <span class="text-muted fs-7">(Opsional)</span></label>
                                    ...
                                    <div class="form-text text-muted">Field legacy, gunakan Harga Beli & Harga Jual di bawah</div>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
