                        ...
                        <tbody>
                            @forelse($customerInvoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="fw-semibold text-gray-700">{{ $invoice->organization?->name ?? '—' }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <span class="fw-bold text-gray-900">Rp
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-10">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <span class="text-gray-700 fs-5 fw-semibold mb-2">Belum Ada Tagihan ke
                                                RS/Klinik</span>
                                            <span class="text-gray-500 fs-6">Tagihan akan muncul setelah dibuat dari Goods
                                                Receipt.</span>
                                            @can('create_invoices')
                                                <a href="{{ route('web.invoices.customer.create') }}"
