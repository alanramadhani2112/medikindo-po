            ...
            <div class="d-flex align-items-center gap-3 mb-2">
                ...
                @if($invoice->goods_receipt_id)
                    <span class="badge badge-light-success">
                        <i class="ki-solid ki-check-circle fs-5 me-1"></i>
                                    ...
                                    <td>
                                        @if($invoice->goods_receipt_id)
                                            ...
                                            <span class="badge badge-light-success ms-2">
                                                <i class="ki-solid ki-check fs-7"></i>
                                                Verified
                                            </span>
                                        @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-light-primary">
                                                <i class="ki-solid ki-lock fs-7 me-1"></i>
                                                {{ $item->batch_no ?? '—' }}
                                            </span>
                                        </td>
                                        <td>
        ...
        <div class="col-lg-4">
            <div class="d-flex flex-column gap-5">
                ...
                <div class="card border-primary">
                    <div class="card-header bg-light-primary">
                        <h3 class="card-title text-primary">
                            <i class="ki-solid ki-bank fs-2 me-2"></i>
                            Instruksi Pembayaran
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-primary d-flex align-items-start mb-5">
                            <i class="ki-solid ki-information-5 fs-2x text-primary me-3"></i>
                            <div class="fs-7">
                        ...
                        <div class="alert alert-warning d-flex align-items-start">
                            <i class="ki-solid ki-information fs-2x text-warning me-3"></i>
                            <div class="fs-7">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="ki-solid ki-note fs-2 me-2"></i>
                            Catatan
                        </h3>
                    </div>
                    <div class="card-body">
