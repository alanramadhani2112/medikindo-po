            ...
            <div class="card card-flush h-100">
                <div class="card-body d-flex align-items-center py-5">
                    ...
                    <div>
                        ...
                        <span class="text-gray-900 fw-bold fs-2">{{ $notifications->where('read_at', '!=', null)->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-flush h-100">
                <div class="card-body d-flex align-items-center py-5">
                    ...
                    <div>
                        ...
                        <span class="text-gray-900 fw-bold fs-2">{{ $notifications->where('created_at', '>=', now()->startOfDay())->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="d-flex align-items-start gap-5">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-3">
                                        ...
                                        <div class="separator separator-dashed d-none d-md-block" style="width: 1px; height: 20px;"></div>
                                        
                                        <div class="d-flex align-items-center gap-2">
                                            @if(isset($data['action_url']))
                                                <a href="{{ $data['action_url'] }}" class="btn btn-sm btn-light-primary">
                                                    <i class="ki-outline ki-facebook fs-5"></i>
                                                    Lihat Detail
                                                </a>
                                            @endif
                    ...
                    <div class="card">
                        <div class="card-body text-center py-20">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <p class="text-gray-600 fs-5 mb-0">Seluruh pesan dan update aktivitas sistem akan muncul di sini.</p>
                            </div>
                        </div>
                    </div>
                @endforelse
