...
<div class="d-flex justify-content-between align-items-center mb-7">
    <div>
        ...
        <p class="text-gray-600 fs-6 mb-0">Selamat datang, {{ auth()->user()->name }} - Monitoring sistem secara
            menyeluruh</p>
    </div>
        ...
        <div class="row g-5 g-xl-8">
            @foreach ($group['cards'] as $card)
                <div class="col-12 col-md-6 col-xl-3">
                    <div
                        class="card card-flush h-100 {{ isset($card['alert']) && $card['alert'] ? 'border border-' . $card['color'] . ' border-2' : '' }}">
                        <div class="card-body d-flex flex-column justify-content-between p-6">
                            <div class="d-flex align-items-center justify-content-between mb-5">
                                    ...
                                    @if (isset($card['growth']))
                                        <div class="d-flex align-items-center mt-2">
                                            @if ($card['growth']['direction'] === 'up')
                                                <i
                                                    class="ki-outline ki-arrow-up fs-5 text-{{ $card['growth']['color'] }} me-1"></i>
                                            @elseif($card['growth']['direction'] === 'down')
                                                <i
                                                    class="ki-outline ki-arrow-down fs-5 text-{{ $card['growth']['color'] }} me-1"></i>
                                            @else
                                                <i
                                                    class="ki-outline ki-minus fs-5 text-{{ $card['growth']['color'] }} me-1"></i>
                                            @endif
                                            <span
                                                class="text-{{ $card['growth']['color'] }} fw-bold fs-7">{{ $card['growth']['percentage'] }}%</span>
                                ...
                                <div class="d-flex align-items-center justify-content-center bg-light-{{ $card['color'] }} rounded"
                            ...
                            @if (isset($card['alert']) && $card['alert'])
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-{{ $card['color'] }} fw-semibold fs-7">Memerlukan
                                        perhatian</span>
                                </div>
                            @endif
                        </div>
...
@if (isset($chartData))
    <div class="mb-7">
        ...
        <div class="row g-5 g-xl-8 mb-7">
            ...
            <div class="col-xl-4">
                <x-charts.donut-chart chart-id="poStatusChart" title="PO by Status"
                    subtitle="Distribusi status purchase order" :labels="$chartData['poStatus']['labels']" :data="$chartData['poStatus']['data']" :colors="$chartData['poStatus']['colors']"
                    height="350" />
            </div>

            {{-- Monthly PO Trend --}}
            <div class="col-xl-8">
                <x-charts.line-chart chart-id="monthlyPOTrendChart" title="Monthly PO Trend"
                    subtitle="Trend jumlah PO 6 bulan terakhir" :labels="$chartData['monthlyPOTrend']['labels']" :datasets="$chartData['monthlyPOTrend']['datasets']" height="350" />
            </div>
        </div>
        ...
        <div class="row g-5 g-xl-8 mb-7">
            {{-- Monthly Revenue --}}
            <div class="col-xl-6">
                <x-charts.bar-chart chart-id="monthlyRevenueChart" title="Monthly Revenue"
                    subtitle="Total nilai PO per bulan (6 bulan terakhir)" :labels="$chartData['monthlyRevenue']['labels']" :datasets="$chartData['monthlyRevenue']['datasets']"
                    height="350" />
            </div>

            {{-- Cash Flow Trend --}}
            <div class="col-xl-6">
                <x-charts.line-chart chart-id="cashFlowChart" title="Cash Flow Trend"
                    subtitle="Kas masuk & keluar 30 hari terakhir" :labels="$chartData['cashFlowTrend']['labels']" :datasets="$chartData['cashFlowTrend']['datasets']" height="350" />
            </div>
        </div>
    </div>
@endif
                        ...
                        <tbody>
                            @forelse($recentActivity as $log)
                                <tr>
                                    <td class="ps-4">
                                        <span
                                            class="text-gray-900 fw-bold fs-6">{{ $log->user->name ?? 'System' }}</span>
                                        <span
                                            class="text-muted fw-semibold d-block fs-7">{{ $log->user->email ?? '-' }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span
                                            class="badge badge-light-{{ $actionColor }} fs-7 fw-semibold">{{ strtoupper($log->action) }}</span>
                                    </td>
                                    <td class="text-end pe-4">
                                        <span
                                            class="text-gray-700 fw-semibold fs-6">{{ $log->occurred_at->format('d M Y H:i') }}</span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center py-10">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <span class="text-gray-700 fs-5 fw-semibold">Belum ada aktivitas
                                                tercatat</span>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="d-flex flex-column gap-3">
                    @can('manage_users')
                        <a href="{{ route('web.users.index') }}"
                            class="btn btn-light-primary justify-content-start text-start">
                    ...
                    @can('manage_products')
                        <a href="{{ route('web.products.index') }}"
                            class="btn btn-light-success justify-content-start text-start">
                    ...
                    @can('manage_organizations')
                        <a href="{{ route('web.organizations.index') }}"
                            class="btn btn-light-info justify-content-start text-start">
                    ...
                    @can('manage_suppliers')
                        <a href="{{ route('web.suppliers.index') }}"
                            class="btn btn-light-warning justify-content-start text-start">
                    ...
                    @endcan
                    <a href="{{ route('web.dashboard.audit') }}"
                        class="btn btn-light-dark justify-content-start text-start">
            ...
            <div class="card card-flush border border-danger border-2">
                <div class="card-header border-0 pt-6 bg-light-danger">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-danger mt-1 fw-semibold fs-7">Log error dan transaksi gagal yang memerlukan
                            perhatian segera</span>
                    </h3>
                    <div class="card-toolbar">
                            ...
                            <tbody>
                                @foreach ($auditLogs as $log)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="text-gray-800 fw-semibold fs-6">{{ $log->description }}</span>
                                        </td>
                                        <td>
            ...
            <div class="col-12 col-md-6 col-xl-3">
                <div class="card card-flush bg-light-success h-100">
                    <div class="card-body p-6">
                        ...
                        <div class="fw-bold fs-2x text-gray-900 mb-2">
                            {{ number_format($analytics['purchaseSummary']['total_quantity'], 0, ',', '.') }}</div>
            ...
            <div class="col-12 col-md-6 col-xl-3">
                <div class="card card-flush bg-light-primary h-100">
                    <div class="card-body p-6">
                        ...
                        <div class="fw-bold fs-2x text-gray-900 mb-2">Rp
                            {{ number_format($analytics['purchaseSummary']['total_value'], 0, ',', '.') }}</div>
            ...
            <div class="col-12 col-md-6 col-xl-3">
                <div class="card card-flush bg-light-info h-100">
                    <div class="card-body p-6">
                        ...
                        <div class="fw-bold fs-2x text-gray-900 mb-2">
                            {{ number_format($analytics['purchaseSummary']['month_quantity'], 0, ',', '.') }}</div>
            ...
            <div class="col-12 col-md-6 col-xl-3">
                <div class="card card-flush bg-light-warning h-100">
                    <div class="card-body p-6">
                        ...
                        <div class="fw-bold fs-2x text-gray-900 mb-2">Rp
                            {{ number_format($analytics['purchaseSummary']['avg_order_value'], 0, ',', '.') }}</div>
                                ...
                                <tbody>
                                    @forelse($analytics['topProducts'] as $index => $product)
                                        <tr>
                                            <td class="ps-4">
                                                <span
                                                    class="badge badge-light-primary fs-7 fw-bold">{{ $index + 1 }}</span>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span
                                                        class="text-gray-900 fw-bold fs-6">{{ $product->name }}</span>
                                                    <span class="text-gray-500 fs-7">{{ $product->sku }}</span>
                                                    @if ($product->is_narcotic)
                                                        <span class="badge badge-danger fs-8 mt-1"
                                                            style="width: fit-content;">NARKOTIKA</span>
                                                    @endif
                                                </div>
                                            </td>
                                            <td class="text-end">
                                                <span
                                                    class="text-gray-900 fw-bold">{{ number_format($product->total_quantity, 0, ',', '.') }}</span>
                                            </td>
                                            <td class="text-end">
                                                <span class="text-gray-900 fw-semibold">Rp
                                                    {{ number_format($product->total_value, 0, ',', '.') }}</span>
                                            </td>
                                            <td class="text-end pe-4">
                                                <span class="badge badge-light-info">{{ $product->order_count }}
                                                    PO</span>
                                            </td>
                                        </tr>
                                    @empty
                                    ...
                                    @forelse($analytics['topSuppliers'] as $index => $supplier)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span
                                                        class="text-gray-900 fw-bold fs-6">{{ $supplier->name }}</span>
                                                    <span class="text-gray-500 fs-7">{{ $supplier->phone }}</span>
                                                </div>
                                            </td>
                                            <td class="text-end">
                                                <span
                                                    class="badge badge-light-success fs-7 fw-bold">{{ $supplier->order_count }}
                                                    PO</span>
                                            </td>
                                            <td class="text-end pe-4">
                                                <span class="text-gray-900 fw-semibold">Rp
                ...
                <div class="card card-flush h-100 border border-warning border-2">
                    <div class="card-header border-0 pt-6 bg-light-warning">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-warning mt-1 fw-semibold fs-7">Produk dengan pembelian rendah (6 bulan
                                terakhir)</span>
                        </h3>
                    </div>
                    <div class="card-body pt-3">
                                    ...
                                    @forelse($analytics['slowMovingProducts'] as $product)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge badge-light-warning fs-7">{{ $product->order_count }}</span>
                                            </td>
                                            <td class="text-end pe-4">
                                                @if ($product->last_purchase_date)
                                                    <span
                                                        class="text-gray-700 fs-7">{{ \Carbon\Carbon::parse($product->last_purchase_date)->format('d M Y') }}</span>
                                                @else
                    ...
                    <div class="card-body pt-3">
                        @forelse($analytics['recommendations'] as $recommendation)
                            <div class="alert alert-{{ $recommendation['color'] }} d-flex align-items-start p-4 mb-3">
                                <i
                                    class="ki-outline {{ $recommendation['icon'] }} fs-2x text-{{ $recommendation['color'] }} me-3 mt-1"></i>
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-2">
                                        <h5 class="mb-0 text-{{ $recommendation['color'] }} fw-bold">
                                            {{ $recommendation['title'] }}</h5>
                                        <span
                                            class="badge badge-{{ $recommendation['color'] }} ms-auto">{{ strtoupper($recommendation['priority']) }}</span>
                                    </div>
