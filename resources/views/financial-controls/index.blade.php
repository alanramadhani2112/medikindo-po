                                        ...
                                        <td class="text-center pe-4">
                                            <div class="action-menu-wrapper">
                                                ...
                                                <div class="action-dropdown-menu" style="display: none;">
                                                    <a href="#" class="d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#editModal{{ $limit->id }}">
                                                        <i class="ki-outline ki-parcel fs-3 me-2 text-warning"></i>
                                                        Edit Plafon
                                                    </a>
                                                    ...
                                                    <form method="POST" action="{{ route('web.financial-controls.update', $limit) }}">
                                                        ...
                                                        @if($limit->is_active)
                                                            <button type="submit" name="is_active" value="0" class="d-flex align-items-center text-warning">
                                                                <i class="ki-outline ki-arrow-zigzag-circle fs-3 me-2"></i>
                                                                Nonaktifkan
                                                            </button>
                                                        @else
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        <i class="ki-outline ki-parcel fs-2 me-2 text-warning"></i>
                        Edit Plafon Kredit
                    </h3>
                    <button type="button" class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                        <i class="ki-outline ki-arrow-zigzag fs-1"></i>
                    </button>
                </div>
                <form method="POST" action="{{ route('web.financial-controls.update', $limit) }}">
                    @csrf
